...
for i = 1:nSteps
    ...
    for k = 1:Reg.n
        ...
        if bc{k}.NumS > 0
            ...
            % Source 3
            Einc = bc{k}.s(3).fct(yC{k},i,t,bc{k}.s(3).paras);
            Eincp = bc{k}.s(3).fct(yC{k},i,t-ds/c_c/2,bc{k}.s(3).paras);
            
            Hy{k}(bc{k}.s(3).xpos,:) = Hy{k}(bc{k}.s(3).xpos,:) + dt/ds/c_mu_0*Einc;
            Ez{k}(bc{k}.s(3).xpos-1,:) = Ez{k}(bc{k}.s(3).xpos-1,:) - dt/ds/c_eps_0/c_eta_0*Eincp;
